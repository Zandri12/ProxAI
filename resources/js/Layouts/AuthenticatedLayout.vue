...
import ManagementDropdown from '@/Components/ManagementDropdown.vue';
...
onMounted(() => {
    ...
    console.log('Route user-management.index:', route('user-management.index'));
});
</script>
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                                ...
                                <ManagementDropdown 
                                    ...
                                    :active="route().current('user-management.*') || route().current('role-management.*') || route().current('permission-management.*')"
                                />
                            </div>
                        </div>
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            ...
                            :active="route().current('permission-management.*')"
                        >
